...
phones <- read_features("../data/art_aireggxdist_means.csv",
                          label_map_jm_art, NULL, "pca", "t")
sim <- abscossim
@
...
frep_pairs <- pairs_of(freps_m, list(frep=frep_labels), FUN=sim, result_names="sim")
@
